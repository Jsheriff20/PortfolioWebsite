...
const GetTagInfo = (tag, sx) => {
    ...
    let buttonSx = (tagColour = "#fff", hoverBackgroundColour, forgroundColour, transformScale = 1) => {
        return [
            sx ? sx : {},
            {
                backgroundColor: tagColour,
                color: forgroundColour || findContrastColour(tagColour),
                ...
                ":hover ": {
                    ...
                    background: hoverBackgroundColour || findContrastColour(tagColour),
                    color: tagColour,
                },
            },
        ];
    ...
    switch (tag) {
        case "Android":
            return <Android sx={buttonSx("#a4c639")} />;
        case "Java":
            return (
                <Java
        ...
        case "Firebase":
            return (
                <Firebase
                    onMouseOver={() => setColours((colours.Firebase = ["#5F5F5F", "#4B4B4B", "#7C7C7C", "#5F5F5F"]))}
                    onMouseOut={() => setColours((colours.Firebase = ["#ffa000", "#f57f17", "#ffca28", "#ffa000"]))}
                    colours={colours.Firebase}
                    sx={buttonSx("#5382a1")}
                />
            );
        case "University":
            return <School sx={buttonSx("#fff", "#4B4B4B", "#00688B")} />;
        case "Dissertation":
            return <Article sx={buttonSx("#fff", "#4B4B4B", "#00688B")} />;
        case "C#":
            return (
                <CSharp
        ...
        case "React":
            return (
                <ReactIcon
                    ...
                    sx={buttonSx("#1d2026", "#80deea")}
                />
            );
        case "JavaScript":
            return <Javascript sx={buttonSx("#ffd600", "#000", "#000", "1.8")} />;
        case "NextJS":
            return (
                <NextJs
        ...
        case "Security":
            return <Security sx={buttonSx("#fff", "#990000 ", "#990000 ")} />;
        case "Tensorflow":
            return (
                <TensorFlow
                    ...
                    sx={buttonSx("#000", "#ffb300")}
                />
            );
        case "Artifical Intelligence":
            return (
                <ArtificialIntelligence
                    onMouseOver={() => setColours((colours.ArtificialIntelligence = ["#00FF00"]))}
        ...
        case "Linux":
            return (
                <Linux
                    onMouseOver={() => setColours((colours.Linux = ["#000"]))}
        ...
        case "Hadoop":
            return (
                <Hadoop
                    onMouseOver={() =>
                        setColours(
                            (colours.Hadoop = ["#E3E3E3", "#F6F6F6", "#B6B6B6", "#B6B6B6", "#424242", "#F9F9F9"])
                        )
                    }
                    onMouseOut={() =>
